 ...
 * Slug: greenshift/footer-default
...
<!-- wp:column {"width":"18.75%"} -->
<div class="wp-block-column" style="flex-basis:18.75%"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"spacing":{"margin":{"top":"0","right":"0","bottom":"var:preset|spacing|50","left":"0"}}}} -->
...
<!-- wp:list {"style":{"typography":{"lineHeight":"2"}},"className":"is-style-nounderline","fontSize":"xsmall"} -->
<ul class="is-style-nounderline has-xsmall-font-size" style="line-height:2"><!-- wp:list-item -->
...
<!-- wp:paragraph {"fontSize":"xsmall"} -->
<p class="has-xsmall-font-size">Copyright LLC</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->